...
exports.chat_insert = function(){
    return {
        "chat_user_id" : _gObjectID,
        "chat_dest_user_id" : _gObjectID,
        "chat_createddate" : Date,
        "chat_text" : String,
        "chat_type" : _gObjectID,
        "chat_url" : String            
    }
};

exports.map_location_insert = function(){
    return {
        "mapl_user_id" : _gObjectID,
        "mpal_map_currentlocation" : [ Number , Number ]
    }
};
